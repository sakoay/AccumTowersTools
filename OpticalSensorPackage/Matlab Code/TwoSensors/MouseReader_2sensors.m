...
% class property.
%
classdef MouseReader_2sensors < handle
	...
	properties (Access = private, Constant = true)
		...
		FORMAT_STR = '%d;%d;%d;%d'; % format string for strread()
	...
	methods
		...
		% constructor
		function [ obj ] = MouseReader_2sensors( port_name )
  ...
  function [] = update_delta_xy( obj )
    ...
    try
      [my_delta_x, my_delta_y, my_delta_x2, my_delta_y2] = strread(str, obj.FORMAT_STR);
